...
$(document).on(
    "change",
    "body #blog_social_form #enable_social_button",
    function (e) {
        $("body #blog_social_form #enable_social_button").toggleClass(
            "data-check"
        );
        if (
            $("body #blog_social_form #enable_social_button").hasClass(
                "data-check"
            )
        ) {
...
$(document).on(
    "change",
    "body #store_blog_from #enable_social_button",
    function (e) {
...
function commonLoader() {
    ...
    if ($("#data_picker1").length) {
        $("#data_picker1").each(function (index) {
            (function () {
                const d_week = new Datepicker(
                    document.querySelector("#data_picker1"),
                    {
                        buttonClass: "btn",
                        format: "yyyy-mm-dd",
                    }
    ...
    if ($("#data_picker2").length) {
        $("#data_picker2").each(function (index) {
            (function () {
                const d_week = new Datepicker(
                    document.querySelector("#data_picker2"),
                    {
                        buttonClass: "btn",
                        format: "yyyy-mm-dd",
                    }
