@extends('storefront.layout.index')
@section('page-title')
    {{__('Customer Home')}}
@endsection
@section('content')
                                                        ...
                                                        <div class="card-image">
                                                            ...
                                                            <a href="{{route('store.product.product_view',[$store->slug,$product->id])}}">
                                                                @if(!empty($product->is_cover) && \Storage::exists('uploads/is_cover_image/'.$product->is_cover))
                                                                    <img alt="Image placeholder" src="{{$logo1.(isset($product->is_cover) && !empty($product->is_cover)?$product->is_cover:'default_img.png')}}" class="img-center img-fluid">
