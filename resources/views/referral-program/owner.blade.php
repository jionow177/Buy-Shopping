                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-md-6 ">
                                    <div class = "border border-2 p-3">
                                        <h4>{{ __('Refer ') . \Auth::user()->name . __(' and earn ') . $currency . (isset($setting) ? $setting->minimum_threshold_amount : '') . __(' per paid signup!') }}</h4>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 mt-2">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="#!" class="btn btn-sm btn-light-primary w-100 cp_link"
                                            ...
                                            data-bs-original-title="Click to copy register link">
                                    ...
                                    @if (!isset($setting) || empty($setting) || $setting->is_enable == 0)
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    {{-- <div class="col-lg-6 col-sm-6 col-md-6 ">
                                        <div class = "border border-2 p-3">
                                            <h4>{{ __('Paid Commission Amount : ' . $currency . $paidAmount) }}</h4>
                                        </div>
                                    </div> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($transaction->status == 0)
                                                            <span
                                                                class="status_badge badge bg-danger p-2 px-3 rounded">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 1)
                                                            <span
                                                                class="status_badge badge bg-warning p-2 px-3 rounded">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 2)
                                                            <span
                                                                class="status_badge badge bg-primary p-2 px-3 rounded">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                                        @endif
                                                    </td>
