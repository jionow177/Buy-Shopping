...
{{-- @dd(Module::asset('LandingPage:Resources/assets/css/style.css')) --}}
@if ($adminSettings['cust_darklayout'] == 'on')
                ...
                <div class="col-xxl-4 col-md-6">
                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        @if ($settings['home_live_demo_link'])
                            <a href="{{ $settings['home_live_demo_link'] }}" class="btn btn-outline-dark">{{__('Live Demo ')}}<i data-feather="play-circle" class="ms-2"></i></a>
                        @endif
                        @if ($settings['home_buy_now_link'])
                            <a href="{{ $settings['home_buy_now_link'] }}" class="btn btn-outline-dark">{{__('Buy Now ')}}<i data-feather="lock" class="ms-2"></i></a>
                        @endif
                    </div>
                </div>
            ...
            <div class="row gy-3">
                <div class="col-xxl-4">
                    ...
                    @if ($settings['feature_buy_now_link'])
                        <a href="{{ $settings['feature_buy_now_link'] }}" class="btn btn-primary rounded-pill d-inline-flex align-items-center">{{__('Buy Now ')}}<i data-feather="lock" class="ms-2"></i></a>
                    @endif
                </div>
                <div class="col-xxl-8">
                    <div class="row">
                    ...
                    @if ($key % 2 == 0)
                        <div class="row align-items-center justify-content-center mb-4">
                            <div class="col-lg-4 col-md-6">
                                ...
                                <a href="{{ $value['other_feature_buy_now_link'] }}" class="btn btn-primary rounded-pill d-inline-flex align-items-center">{{__('Buy Now ')}}<i data-feather="lock" class="ms-2"></i></a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                @if ($settings['discover_live_demo_link'])
                    <a href="{{ $settings['discover_live_demo_link'] }}" class="btn btn-outline-light rounded-pill">{{__('Live Demo ')}}<i data-feather="play-circle" class="ms-2"></i> </a>
                @endif

                @if ($settings['discover_buy_now_link'])
                    <a href="{{ $settings['discover_buy_now_link'] }}" class="btn btn-primary rounded-pill">{{__('Buy Now ')}}<i data-feather="lock" class="ms-2"></i> </a>
                @endif
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                ...
                @foreach ($collection as $key => $value)
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card price-card shadow-none {{ $adminSettings['cust_darklayout'] == 'off' ? ($key == 1 ? 'bg-light-primary' : ($key == 2 ? 'bg-dark' : '')) : 'bg-dark' }}">
                            <div class="card-body">
                                <span class="price-badge  bg-dark">{{ $value->name }}</span>
                                <span class="mb-4 f-w-600 display-3">{{ (!empty($payment_setting['currency_symbol']) ? $payment_setting['currency_symbol'] : '$') . $value->price }}<small
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        @if ($value->storage_limit != '0')
                                            ...
                                            @else
                                                {{ __('Storage Limit : ') }}{{ $value->storage_limit }}{{ ' MB' }}
                                            @endif
                                        @else
                                            <span class="">
                                                <i class="text-danger ti ti-circle-plus"></i></span>
                                ...
                                <div class="row mb-3">
                                    <div class="col-4 text-center ">
                                        @if ($value->max_products == '-1')
                                            <small
                                                class="mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }} ">{{ __('Unlimited') }}</small>
                                        @else
                                            <b>
                                                <span
                                                    class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->max_products }}</span>
                                            </b>
                                        @endif
                                    ...
                                    <div class="col-4 text-center">
                                        <span class="mb-0">
                                            @if ($value->max_stores == '-1')
                                                <small
                                                    class="mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }} ">{{ __('Unlimited') }}</small>
                                            @else
                                                <span
                                                    class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->max_stores }}</span>
                                            @endif
                                        </span>
                                    ...
                                    <div class="col-4 text-center">
                                        <span class="mb-0">
                                            ...
                                            @else
                                                <span
                                                    class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">
                                                    {{ $value->max_users }}
                                                </span>
                                            @endif
                                        </span>
