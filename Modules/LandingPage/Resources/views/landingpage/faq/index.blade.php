                                    ...
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
                                                ...
                                                {{ $settings['faq_status'] == 'on' ? 'checked="checked"' : '' }}>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('faq_create') }}" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" data-title="{{ __('Create FAQ') }}" title="{{ __('Create FAQ') }}"
                                                        ...
                                                        <span>
                                                            <div class="action-btn ms-2">
                                                                <a href="#"
                                                                    ...
                                                                    data-ajax-popup="true" data-title="{{ __('Edit FAQ') }}"
                                                                    data-size="lg" data-bs-toggle="tooltip"
                                                                    title="{{ __('Edit FAQ') }}"
                                                                    data-original-title="{{ __('Edit FAQ') }}">
