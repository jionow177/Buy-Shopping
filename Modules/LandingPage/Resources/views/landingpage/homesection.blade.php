            ...
            <div class="row">
                ...
                <div>
                    <div class="card">
                        ...
                        {{ Form::open(['route' => 'homesection.store', 'method' => 'post', 'id' => 'imageUploadForm', 'enctype' => 'multipart/form-data']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="{{ $logo.'/site_logo.png' }}" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                            ...
                                            <div class="card mb-3 border shadow-none product_Image">
                                                <div class="px-2 py-2">
                                                    <div class="row align-items-center">
                                                        <div class="col ml-n2">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="{{ $logo.'/'.$home_logo }}" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                                            </p>
                                                        </div>
                                                        <div class="col-auto actions">
