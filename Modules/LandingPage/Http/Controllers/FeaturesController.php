...
class FeaturesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['feature_status']         = $request->feature_status ?? "off";
        ...
        return redirect()->back()->with(['success' => 'Feature setting update successfully']);
    }
    ...
    public function feature_highlight_create(Request $request)
    {
        $validator = \Validator::make(
            $request->all(),
            [
                'highlight_feature_heading' => 'required',
            ]
        );
        if ($validator->fails()) {
            $messages = $validator->getMessageBag();
    ...
    public function features_store(Request $request)
    {
        ...
        $validator = \Validator::make(
            $request->all(),
            [
                'other_features_heading' => 'required',
            ]
        );
        if ($validator->fails()) {
            $messages = $validator->getMessageBag();
        ...
        return redirect()->back()->with(['success' => 'Feature block created successfully']);
    }
